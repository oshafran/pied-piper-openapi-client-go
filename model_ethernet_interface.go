...
func (o *EthernetInterface) GetStaticIpAddressSubnetMask() string {
	if o == nil || isNil(o.StaticIpAddressSubnetMask) {
		var ret string
		return ret
	}
...
func (o *EthernetInterface) GetStaticRouteIp() string {
	if o == nil || isNil(o.StaticRouteIp) {
		var ret string
		return ret
	}
...
func (o *EthernetInterface) GetWanConfiguration() string {
	if o == nil || isNil(o.WanConfiguration) {
		var ret string
		return ret
	}
