...
*/
func (a *MDPOffboardingApiService) DisconnectFromMdp(ctx context.Context, nmsId string) ApiDisconnectFromMdpRequest {
	return ApiDisconnectFromMdpRequest{
		ApiService: a,
		ctx: ctx,
		nmsId: nmsId,
...
func (a *MDPOffboardingApiService) DisconnectFromMdpExecute(r ApiDisconnectFromMdpRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
...
*/
func (a *MDPOffboardingApiService) Offboard(ctx context.Context, nmsId string) ApiOffboardRequest {
	return ApiOffboardRequest{
		ApiService: a,
		ctx: ctx,
		nmsId: nmsId,
...
// Execute executes the request
func (a *MDPOffboardingApiService) OffboardExecute(r ApiOffboardRequest) (*http.Response, error) {
	var (
