...
func (o *SchemaDefinition) GetCountOfUniqueuVertexAndEdgeObjectsCreated() int32 {
	if o == nil || o.CountOfUniqueuVertexAndEdgeObjectsCreated == nil {
		var ret int32
		return ret
	}
...
func (o *SchemaDefinition) GetCountOfVertexAndEdgesRegisteredWithDeviceDataManager() int32 {
	if o == nil || o.CountOfVertexAndEdgesRegisteredWithDeviceDataManager == nil {
		var ret int32
		return ret
	}
...
func (o *SchemaDefinition) GetVertexDefinitionsForDataCollection() []string {
	if o == nil || o.VertexDefinitionsForDataCollection == nil {
		var ret []string
		return ret
	}
...
func (o *SchemaDefinition) GetVertexDefinitionsFoundInDBWithData() []VertexDefinition {
	if o == nil || o.VertexDefinitionsFoundInDBWithData == nil {
...
func (o *SchemaDefinition) GetVertexDefinitionsFoundInDBWithoutData() []string {
	if o == nil || o.VertexDefinitionsFoundInDBWithoutData == nil {
		var ret []string
		return ret
	}
...
func (o *SchemaDefinition) GetVertexDefinitionsNotFoundInDB() []string {
	if o == nil || o.VertexDefinitionsNotFoundInDB == nil {
		var ret []string
		return ret
	}
...
func (o *SchemaDefinition) GetVertexDefinitionsNotRegisteredWithDeviceDataManager() []string {
	if o == nil || o.VertexDefinitionsNotRegisteredWithDeviceDataManager == nil {
		var ret []string
		return ret
	}
