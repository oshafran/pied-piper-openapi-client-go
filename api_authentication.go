...
func (r ApiDataserviceClientTokenGetRequest) Execute() (string, *http.Response, error) {
...
//  @return string
func (a *AuthenticationApiService) DataserviceClientTokenGetExecute(r ApiDataserviceClientTokenGetRequest) (string, *http.Response, error) {
	var (
...
func (r ApiJSecurityCheckPostRequest) Execute() (string, *http.Response, error) {
...
// Execute executes the request
//  @return string
func (a *AuthenticationApiService) JSecurityCheckPostExecute(r ApiJSecurityCheckPostRequest) (string, *http.Response, error) {
	var (
