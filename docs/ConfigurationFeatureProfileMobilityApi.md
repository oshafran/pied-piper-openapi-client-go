...
func main() {
    profileId := "profileId_example" // string | Feature Profile ID
    ethernet := *openapiclient.NewEthernet("Name_example", "Type_example") // Ethernet | Ethernet Profile Parcel (optional)
...
func main() {
    profileId := "profileId_example" // string | Feature Profile ID
    networkProtocol := *openapiclient.NewNetworkProtocol("Name_example", "Type_example") // NetworkProtocol | NetworkProtocol Profile Parcel (optional)
...
func main() {
    profileId := "profileId_example" // string | Feature Profile ID
    securityPolicy := *openapiclient.NewSecurityPolicy("Name_example", "Type_example") // SecurityPolicy | SecurityPolicy Profile Parcel (optional)
...
func main() {
    profileId := "profileId_example" // string | Feature Profile ID
    vpn := *openapiclient.NewVpn("Name_example", "Type_example", *openapiclient.NewSiteToSiteVpn("LocalInterface_example", "LocalPrivateSubnet_example", "PreSharedSecret_example", "RemotePrivateSubnets_example", "RemotePublicIp_example")) // Vpn | Vpn Profile Parcel (optional)
...
func main() {
    profileId := "profileId_example" // string | Feature Profile ID
    wifi := *openapiclient.NewWifi("Name_example", "Type_example") // Wifi | Wifi Profile Parcel (optional)
...
func main() {
    profileId := "profileId_example" // string | Feature Profile ID
    cellularId := "cellularId_example" // string | Profile Parcel ID
    cellular := *openapiclient.NewCellular("Name_example", "Type_example", *openapiclient.NewSimSlotConfig()) // Cellular | Cellular Profile Parcel (optional)
...
func main() {
    profileId := "profileId_example" // string | Feature Profile ID
    networkProtocolId := "networkProtocolId_example" // string | Profile Parcel ID
    networkProtocol := *openapiclient.NewNetworkProtocol("Name_example", "Type_example") // NetworkProtocol | Network Protocol Profile Parcel (optional)
...
func main() {
    profileId := "profileId_example" // string | Feature Profile ID
    securityPolicyId := "securityPolicyId_example" // string | Profile Parcel ID
    securityPolicy := *openapiclient.NewSecurityPolicy("Name_example", "Type_example") // SecurityPolicy | Security Policy Profile Parcel (optional)
