...
func (o *OMP) GetAdvertisementInterval() int32 {
	if o == nil || o.AdvertisementInterval == nil {
		var ret int32
		return ret
	}
...
func (o *OMP) GetGracefulRestart() int32 {
	if o == nil || o.GracefulRestart == nil {
		var ret int32
		return ret
	}
...
func (o *OMP) GetPathsAdvertisedPerPrefix() int32 {
	if o == nil || o.PathsAdvertisedPerPrefix == nil {
		var ret int32
		return ret
	}
...
func (o OMP) MarshalJSON() ([]byte, error) {
	...
	if o.PathsAdvertisedPerPrefix != nil {
