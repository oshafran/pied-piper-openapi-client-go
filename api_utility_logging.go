...
type ApiDebugLogRequest struct {
	ctx context.Context
...
func (r ApiDebugLogRequest) LoggerName(loggerName string) ApiDebugLogRequest {
	r.loggerName = &loggerName
	return r
}

func (r ApiDebugLogRequest) LogMessage(logMessage string) ApiDebugLogRequest {
	r.logMessage = &logMessage
	return r
}

func (r ApiDebugLogRequest) Execute() (*http.Response, error) {
...
Test whether logging works
 ...
 @return ApiDebugLogRequest

Deprecated
*/
func (a *UtilityLoggingApiService) DebugLog(ctx context.Context) ApiDebugLogRequest {
	return ApiDebugLogRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Deprecated
func (a *UtilityLoggingApiService) DebugLogExecute(r ApiDebugLogRequest) (*http.Response, error) {
	var (
...
type ApiListLogFileDetailsRequest struct {
	ctx context.Context
	ApiService *UtilityLoggingApiService
}

func (r ApiListLogFileDetailsRequest) Execute() (string, *http.Response, error) {
...
Lists content of log file. This API accepts content type as text/plain. It is mandatory to provide response content type.  Any other content type would result in empty response.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiListLogFileDetailsRequest
*/
func (a *UtilityLoggingApiService) ListLogFileDetails(ctx context.Context) ApiListLogFileDetailsRequest {
	return ApiListLogFileDetailsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return string
func (a *UtilityLoggingApiService) ListLogFileDetailsExecute(r ApiListLogFileDetailsRequest) (string, *http.Response, error) {
	var (
...
func (r ApiListLoggersRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
...
*/
func (a *UtilityLoggingApiService) ListLoggers(ctx context.Context) ApiListLoggersRequest {
	return ApiListLoggersRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *UtilityLoggingApiService) ListLoggersExecute(r ApiListLoggersRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiListVManageServerLogLastNLinesRequest struct {
	ctx context.Context
	ApiService *UtilityLoggingApiService
	lines *int64
}
...
// Number of lines
func (r ApiListVManageServerLogLastNLinesRequest) Lines(lines int64) ApiListVManageServerLogLastNLinesRequest {
	r.lines = &lines
	return r
}

func (r ApiListVManageServerLogLastNLinesRequest) Execute() (string, *http.Response, error) {
...
List last N lines of log file. This API accepts content type as text/plain. It is mandatory to provide response content type.  Any other content type would result in empty response.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiListVManageServerLogLastNLinesRequest
*/
func (a *UtilityLoggingApiService) ListVManageServerLogLastNLines(ctx context.Context) ApiListVManageServerLogLastNLinesRequest {
	return ApiListVManageServerLogLastNLinesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return string
func (a *UtilityLoggingApiService) ListVManageServerLogLastNLinesExecute(r ApiListVManageServerLogLastNLinesRequest) (string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiSetLogLevelRequest) LoggerName(loggerName string) ApiSetLogLevelRequest {
	r.loggerName = &loggerName
	return r
}

func (r ApiSetLogLevelRequest) LogLevel(logLevel string) ApiSetLogLevelRequest {
	r.logLevel = &logLevel
	return r
}

func (r ApiSetLogLevelRequest) Execute() (*http.Response, error) {
...
*/
func (a *UtilityLoggingApiService) SetLogLevel(ctx context.Context) ApiSetLogLevelRequest {
	return ApiSetLogLevelRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *UtilityLoggingApiService) SetLogLevelExecute(r ApiSetLogLevelRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
